    ...
    return [
        'en' => [
          ...
          'USER_SYSTEM_DISABLED' => [
              'Access system changed - Assistenza Archiui',
          ...
          'USER_SYSTEM_ENABLED' => [
              'Account created - Assistenza Archiui',
              'Account created',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Ticket created - Assistenza Archiui',
              'Ticket created',
        ...
        'de' => [
          'USER_SIGNUP' => [
              'Anmelden {{to}} - Assistenza Archiui',
          ...
          'USER_SYSTEM_ENABLED' => [
              'Account erstellt - Assistenza Archiui',
              'Account erstellt',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Ticket erstellt - Assistenza Archiui',
              'Ticket erstellt',
        ...
        'es' => [
          'USER_SIGNUP' => [
              'Registrado {{to}} - Assistenza Archiui',
              'Verifica tu cuenta',
          ...
          'USER_SYSTEM_DISABLED' => [
              'Sistema de acceso cambiado - Assistenza Archiui',
          ...
          'USER_SYSTEM_ENABLED' => [
              'Cuenta creada - Assistenza Archiui',
              'Cuenta creada',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Ticket creado - Assistenza Archiui',
              'Ticket creado',
          ...
          'TICKET_RESPONDED' => [
              '#{{ticketNumber}} Nueva respuesta - Assistenza Archiui',
              'Nueva respuesta',
          ...
          'TICKET_CLOSED' => [
              '#{{ticketNumber}} Ticket cerrado - Assistenza Archiui',
              'Ticket cerrado',
        ...
        'fr' => [
          'USER_SIGNUP' => [
              'S\'inscrire {{to}} - Assistenza Archiui',
          ...
          'USER_SYSTEM_DISABLED' => [
              'Système d\'accès modifié - Assistenza Archiui',
          ...
          'USER_SYSTEM_ENABLED' => [
              'Compte créé - Assistenza Archiui',
              'Compte créé',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Ticket créé - Assistenza Archiui',
              'Ticket créé',
          ...
          'TICKET_RESPONDED' => [
              '#{{ticketNumber}} Nouvelle réponse - Assistenza Archiui',
              'Ticket répondu',
          ...
          'TICKET_CLOSED' => [
              '#{{ticketNumber}} Billet fermé - Assistenza Archiui',
              'Billet fermé',
        ...
        'in' => [
          ...
          'USER_SYSTEM_DISABLED' => [
              'sistem akses berubah - Assistenza Archiui',
          ...
          'USER_SYSTEM_ENABLED' => [
              'Akun telah dibuat - Assistenza Archiui',
              'खाता बन गय',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} tiket dibuat - Assistenza Archiui',
              'टिकट बनाय',
        ...
        'it' => [
          'USER_SIGNUP' => [
              'Registrazione - Assistenza Archiui',
              'Verifica il tuo account',
              'Benvenuto {{name}}! Verifica ora il tuo indirizzo email.',
              'Premi il pulsante "Verifica" qui sotto oppure copia e incolla nel tuo browser il seguente link: {{url}}/verify-token/{{to}}/{{verificationToken}}',
          ],
          'USER_PASSWORD' => [
              'Password modificata - Assistenza Archiui',
              'Password modificata',
              'Ciao {{name}}. Vogliamo informarti che la tua password è stata modificata dal tuo pannello di controllo.'
          ],
          'USER_EMAIL' => [
              'E-mail modificata - Assistenza Archiui',
          ...
          'PASSWORD_FORGOT' => [
              'Recupera la password - Assistenza Archiui',
              'Recupera password',
          ...
          'USER_SYSTEM_DISABLED' => [
              'Il sistema di accesso è cambiato - Assistenza Archiui',
          ...
          'USER_SYSTEM_ENABLED' => [
              'Account creato - Assistenza Archiui',
              'Account creato',
          ...
          'TICKET_CREATED' => [
              'Creazione ticket #{{ticketNumber}} - Assistenza Archiui',
              'Ticket inviato',
          ...
          'TICKET_RESPONDED' => [
              'Risposta al ticket #{{ticketNumber}} - Assistenza Archiui',
          ...
          'TICKET_CLOSED' => [
              'Chiusura ticket #{{ticketNumber}} - Assistenza Archiui',
              'Ticket chiuso',
        ...
        'pt' => [
          'USER_SIGNUP' => [
              'Inscrever-se {{to}} - Assistenza Archiui',
              'Verifique sua conta',
          ...
          'USER_SYSTEM_DISABLED' => [
              'Sistema de acesso alterado - Assistenza Archiui',
          ...
          'USER_SYSTEM_ENABLED' => [
              'Conta criada - Assistenza Archiui',
              'Conta criada',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Ticket criado - Assistenza Archiui',
              'Ticket criado',
        ...
        'ru' => [
          'USER_SIGNUP' => [
              'Зарегистрироваться {{to}} - Assistenza Archiui',
          ...
          'PASSWORD_FORGOT' => [
              'Восстановить пароль - Assistenza Archiui',
              'Восстановить пароль',
          ...
          'USER_SYSTEM_DISABLED' => [
              'Система доступа изменена - Assistenza Archiui',
          ...
          'USER_SYSTEM_ENABLED' => [
              'Аккаунт создан - Assistenza Archiui',
              'Аккаунт создан',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Создан билет - Assistenza Archiui',
              'Создан билет',
        ...
        'tr' => [
          ...
          'USER_SYSTEM_DISABLED' => [
              'Erişim sistemi değiştirildi - Assistenza Archiui',
          ...
          'USER_SYSTEM_ENABLED' => [
              'Hesap oluşturuldu - Assistenza Archiui',
              'Hesap oluşturuldu',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Bilet oluşturuldu - Assistenza Archiui',
              'Bilet oluşturuldu',
        ...
        'gr' => [
          ...
          'PASSWORD_FORGOT' => [
              'Ανάκτηση κωδικού πρόσβασης - Assistenza Archiui',
          ...
          'USER_SYSTEM_DISABLED' => [
            'Το σύστημα πρόσβασης άλλαξε - Assistenza Archiui',
          ...
          'USER_SYSTEM_ENABLED' => [
            'Δημιουργία λογαριασμού - Assistenza Archiui',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Δημιουργήθηκε εισιτήριο - Assistenza Archiui',
        ...
        'nl' => [
          'USER_SIGNUP' => [
              'Aanmelden {{to}} - Assistenza Archiui',
          ...
          'USER_SYSTEM_DISABLED' => [
            'Toegangssysteem gewijzigd - Assistenza Archiui',
          ...
          'USER_SYSTEM_ENABLED' => [
            'Account is aangemaakt - Assistenza Archiui',
            'Account Aangemaakt',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Incident aangemaakt - Assistenza Archiui',
              'Incident aangemaakt',
          ...
          'TICKET_RESPONDED' => [
              '#{{ticketNumber}} Nieuw antwoord - Assistenza Archiui',
              'Nieuw antwoord',
          ...
          'TICKET_CLOSED' => [
             '#{{ticketNumber}} Incident gesloten - Assistenza Archiui',
        ...
        'pl' => [
          ...
          'USER_SYSTEM_DISABLED' => [
              'Zmieniono dostęp do systemu - Assistenza Archiui',
          ...
          'USER_SYSTEM_ENABLED' => [
              'Twporzenie konta - Assistenza Archiui',
          ...
          'TICKET_CREATED' => [
              '#{{ticketNumber}} Tworzenie zgłoszenia - Assistenza Archiui',
          ...
          'TICKET_RESPONDED' => [
              '#{{ticketNumber}} Nowa odpowiedź - Assistenza Archiui',
          ...
          'TICKET_CLOSED' => [
             '#{{ticketNumber}} Zamknięcie zgłoszenia - Assistenza Archiui',
              'Zgłoszenie zamknięto',
              'Hello, {{name}}. Zgłoszenie pod tytułem <i>{{title}}</i> zostało zamknięte.',
              'Możesz uzyskać dostęp do zgłoszenia poprzez jego numer lub kliknij w przycisk poniżej.'
          ],
          'TICKET_CREATED_STAFF' => [
              '#{{ticketNumber}} Utworzono zgłoszenie - Assistenza Archiui',
              'Zgłoszenie utworzono',
