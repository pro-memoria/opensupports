        ...
        return (
            <div className="create-ticket-form">
                ...
                <Form {...this.getFormProps()}>
                    ...
                    <FormField label={i18n('CLIENT_SITE_PATH')} name="site_url" validation="SITE_URL" required field="input" fieldProps={{size: 'large', url: true}} placeholder="https://nomesito.it" />
